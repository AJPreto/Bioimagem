...
"""
This script performs one-way ANOVA
"""
...
grupo_1 = peso.loc[prov == 1]
grupo_2 = peso.loc[prov == 2]
grupo_3 = peso.loc[prov == 3]
grupos = [grupo_1.tolist(), grupo_2.tolist(), grupo_3.tolist()]
...
media_grupo_3 = statistics.mean(grupo_3)
medias_grupos = [media_grupo_1, media_grupo_2, media_grupo_3]
...
MSF = calculate_MS(SSF, 2)
MSE = calculate_MS(SSE, 27)
...
print("p-value:", anova(grupo_1, grupo_2, grupo_3)[1])
